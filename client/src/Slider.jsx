...
let imgUrl1 = `images/slide-01.jpg`;
let imgUrl2 = `images/slide-02.jpg`;
let imgUrl3 = `images/slide-03.jpg`;
...
const Slider = () => {
  ...
  <div className="wrap-slick1">
    <div className="slick1">
      <div className="item-slick1" style={divStyle1}>
      ...
      <div className="item-slick1" style={divStyle2}>
        <div className="container h-full">
          <div className="flex-col-l-m h-full p-t-100 p-b-30 respon5">
      ...
      <div className="item-slick1" style={divStyle3}>
        <div className="container h-full">
          <div className="flex-col-l-m h-full p-t-100 p-b-30 respon5">
