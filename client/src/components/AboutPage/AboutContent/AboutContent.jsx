				...
				<div className="row">
					...
					<div className="col-lg-6">
						<div className="right-content">
							...
							<div className="quote">
								<i className="fa fa-quote-left"></i><p>Through the HEXASHOP Marketplace, HEXASHOP reaches a growing number of customers and brand partners, enhancing its position as the one-stop fashion and lifestyle destination. HEXASHOP empowers its customers to make informed choices through its responsible product edit and broader shopping journey and connects with a vibrant global community of young and inspiring voices, who share values of inclusivity, societal purpose and self-expression.</p>
							</div>
            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-heading">
                        <h2>Our Services</h2>
                        <span>What makes Hexashop different from the other.</span>
                    </div>
                </div>
