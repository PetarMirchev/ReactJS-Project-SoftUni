...
export const AuthContextProvider = ({ children }) => {
    ...
    //if whe refresh the page (f5), to not logout auto, whe use the logic of useEffect to store the login user (buffer)
    useEffect(() => {
...
//<AuthContext.Provider is used in index.js in ReactDOM ---> root.render(...